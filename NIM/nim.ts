...
export function resetBoard (numberOfRows:number){
    board = [];
...
export function removeMatch (row:number){
...
export function getNimSum():number{
    return board.reduce((acc,curr) => acc^curr,0);
}

export function findWinningMove(nimSum:number) : {rowIndex : number, matchesToRemove : number} {
...
export function keepScore(playerOne : Player, playerTwo : Player){
...
export function updateScoreBoard(highScoreTable : HTMLElement){
...
export function updateBoard(gameBoard : HTMLElement){
