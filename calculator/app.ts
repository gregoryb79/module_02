...
const calcOutput: HTMLSpanElement | null = document.querySelector("#calcOutput");

document.querySelectorAll<HTMLButtonElement>(".calcButton").forEach(button => {
    button.addEventListener("click", (event: Event) => {
        
        console.log(`Button clicked: ${button.textContent}`);
        const calcInput = button.textContent ?? "";
        console.log(`calcInput = ${calcInput}`);
        const inputNumber = Number(calcInput);
