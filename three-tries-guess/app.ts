...
let MyNumber = Math.floor(Math.random() * 10) + 1;//Generates a random integer number between 1 and 10 (inclusive)

// let UserGuess = Number(prompt("I picked an integer number between 1 and 10, try to guess it... " + MyNumber));
let UserGuess = Number(prompt("I picked an integer number between 1 and 10, try to guess it..."));
if (isNaN(UserGuess)){
